...
echo -e "\e[1;33mImportant:\e[0m if using devcontainers through GitHub Codespaces or similar services, it is \e[1mrecommended\e[0m to modify 'db/populate.rb' to use e926 or specify 'rating:g' in the post population\n\nFor help with the devcontainer, see .devcontainer/devcontainer.md\n"
